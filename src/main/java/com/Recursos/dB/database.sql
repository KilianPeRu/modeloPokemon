DROP DATABASE IF EXISTS Javamon;
...
INSERT INTO users(`name`, passwd,state) VALUES
-- BOTS
...
('usergestor', 'usergestor',1);


INSERT INTO moves(`name`, potencia, accuracy, clase,priority,`type`) VALUES
-- Agua:
...
INSERT INTO Pokemon(idTrainer,trainerName,`name`, specie,type1,type2,hp,atk,def,eAtk,eDef,spd,team,move1,move2,move3,move4) VALUES
-- Bot 1
(1,'betabot1','RattataBeta', 'Rattata', 'Normal', null,30,56,35,25,35,72,true,65,100,29,10),
(1,'betabot1','BulbasaurBeta', 'Bulbasaur', 'Planta', 'Veneno',45,49,49,65,65,45,true,75,80,112,63),
(1,'betabot1','MagnemiteBeta', 'Magnemite', 'Acero', 'Electrico',25,35,70,95,55,45,true,27,63,9,24),
(1,'betabot1','AzumarillBeta', 'Azumarill', 'Agua', 'Hada',100,50,80,60,80,50,true,2,3,42,63),
(1,'betabot1','AbsolBeta', 'Absol', 'Siniestro', null,65,130,60,75,60,75,true,83,109,94,15),
(1,'betabot1','CharmanderBeta', 'Charmander', 'Fuego', null,39,52,43,60,50,65,false,34,37,62,118),
(1,'betabot1','CharmanderBeta', 'Charmander', 'Fuego', null,39,52,43,60,50,65,false,34,37,62,118),
(1,'betabot1','CharmanderBeta', 'Charmander', 'Fuego', null,39,52,43,60,50,65,false,34,37,62,118),
(1,'betabot1','CharmanderBeta', 'Charmander', 'Fuego', null,39,52,43,60,50,65,false,34,37,62,118),
(1,'betabot1','CharmanderBeta', 'Charmander', 'Fuego', null,39,52,43,60,50,65,false,34,37,62,118),
...
(1,'betabot1','CharmanderBeta', 'Charmander', 'Fuego', null,39,52,43,60,50,65,false,34,37,62,118),
-- Bot 2
(2,'betabot2','CaterpieBeta', 'Caterpie', 'Bicho', null,45,30,35,20,20,45,true,12,62,null,null),
(2,'betabot2','CharmanderBeta', 'Charmander', 'Fuego', null,39,52,43,60,50,65,true,34,37,62,118),
(2,'betabot2','DiggersbyBeta', 'Diggersby', 'Normal', 'Tierra',85,56,77,50,77,78,true,61,66,104,null),
(2,'betabot2','SandslashBeta', 'Sandslash', 'Tierra', null,75,100,110,45,55,65,true,101,109,88,null),
(2,'betabot2','PrimeapeBeta', 'Primeape', 'Lucha', null,55,105,60,60,70,95,true,57,66,97,null),
(2,'betabot2','RaichuBeta', 'RaichuA', 'Electrico', 'Psiquico',60,85,50,95,85,110,true,82,26,25,55),
-- Bot 3
(3,'betabot3','FurretBeta', 'Furret', 'Normal', null,85,76,64,45,55,90,true,69,87,94,109),
(3,'betabot3','WartortleBeta', 'Wartortle', 'Agua', null,59,63,80,65,80,58,true,5,47,9,95),
(3,'betabot3','BreloomBeta', 'Breloom', 'Planta', 'Lucha',60,130,80,60,60,70,true,57,79,23,7),
(3,'betabot3','MoralesFarigiraf', 'Farigiraf', 'Normal', 'Psiquico',120,90,70,110,70,60,true,72,81,66,55),
(3,'betabot3','HydreigonBeta', 'Hydreigon', 'Dragon', 'Siniestro',92,105,90,125,90,98,true,18,112,93,35),
(3,'betabot3','AntonioBuzzwole', 'Buzzwole', 'Bicho', 'Lucha',107,139,139,53,53,79,true,59,15,64,101),
-- Shop
(4,'shop','AntonioBuzzwole', 'Buzzwole', 'Bicho', 'Lucha',107,139,139,53,53,79,false,59,15,64,101),
(4,'shop','MoralesFarigiraf', 'Farigiraf', 'Normal', 'Psiquico',120,90,70,110,70,60,false,72,81,66,55),
(4,'shop','HydreigonBeta', 'Hydreigon', 'Dragon', 'Siniestro',92,105,90,125,90,98,false,18,112,93,35),
-- Creator users
(8,'usergestor','Charmander', 'Charmander', 'Fuego', null,39,52,43,60,50,65,true,34,37,62,118),
(8,'usergestor','Bulbasaur', 'Bulbasaur', 'Planta', 'Veneno',45,49,49,65,65,45,true,75,80,112,63),
(8,'usergestor','Squirtle', 'Squirtle', 'Agua', null,44,48,65,50,64,43,true,5,47,9,95),
(8,'usergestor','Pikachu', 'Pikachu', 'Electrico', null,45,80,50,75,60,120,true,82,26,25,55)
;